...
// thank you to https://dadroit.com/json-to-string/ for saving me the effort of doing this myself :DDD
...
const tempScoreLabel = document.getElementById("tempScore");
...
function submit() {
    ...
    tempScoreLabel.innerText = `Chosen animal: ${_highestAnimal} with ${_highestPoints} points`;
}
